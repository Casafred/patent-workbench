...
### 核心功能
- 🔐 **用户认证**: 安全的登录系统，支持IP限制
- 💬 **功能一 - AI智能体对话**: 专利领域专属AI对话系统，支持多模态交互和联网搜索
- 📊 **功能二 - 文本批量智能分析**: 批量文本处理，支持智能分类标引、模板管理
- 📁 **功能三 - 本地数据表管理**: 离线Excel处理，同族展开、新旧库合并
- 🔍 **功能四 - 权利要求智能比对**: 多权利要求对比分析，支持同族权利要求对比
- 📄 **功能五 - 批量专利检索与解读**: 批量查询专利信息，AI智能解读
- 🏷️ **功能六 - 独从权识别与可视化**: 自动识别独立/从属权利要求，生成可视化图
- 🖼️ **功能七 - 专利附图智能标记**: OCR识别附图标记，智能匹配说明书
- 📖 **功能八 - 文档OCR与智能分析**: PDF/图片OCR解析，划词交互，悬浮AI对话
- 📚 **功能九 - IPC分类智能查询**: AI预测IPC分类，分类号查询，关键词搜索
- 🌍 **功能十 - 全球专利智能检索**: 对接全球专利数据库，支持CQL语法检索

### 功能亮点
- 🔄 **批量专利解读**: 支持最多50个专利号同时处理，自动获取专利信息并AI智能解读
- 🎯 **权利要求对比**: 2-10个权利要求多维度对比，自动识别引用关系
- 🏷️ **智能缓存**: 专利数据本地缓存，避免重复爬取
- 📋 **全局智能剪贴板**: 跨功能数据共享，一键复制粘贴
- 🎨 **交互式标注**: PDF划词选中、悬浮工具栏、AI对话窗口
- 👤 **游客模式**: 无需注册即可体验核心功能，有限制使用
- 🔍 **全球专利检索**: 对接EPO API，覆盖全球100+国家专利数据
