...
- [ ] 2. Extract and modularize core utilities
  ...
  - [ ] 2.2 Create js/core/component-loader.js
  ...
  - [ ] 2.3 Create js/modules/navigation/tab-navigation.js
...
- [ ] 3. Refactor HTML into components
  ...
  - [ ] 3.5 Extract Feature 2 (Async Batch) component
  ...
  - [ ] 3.6 Extract Feature 3 (Large Batch) component
  ...
  - [ ] 3.7 Extract Feature 4 (Local Patent Library) component
  ...
  - [ ] 3.8 Extract Feature 5 (Claims Comparison) component
  ...
  - [ ] 3.9 Extract Feature 6 (Patent Batch) component
  ...
  - [ ] 3.10 Extract Feature 7 (Claims Processor) component
  ...
  - [ ] 3.11 Extract Feature 8 (Drawing Marker) component
...
- [ ] 4. Checkpoint - Verify HTML refactoring complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Refactor chat.js into modules
  - [ ] 5.1 Create js/modules/chat/ directory structure
  ...
  - [ ] 5.2 Create chat-file-handler.js module
  ...
  - [ ] 5.3 Create chat-conversation.js module
...
- [ ] 6. Refactor claimsProcessorIntegrated.js into modules
  - [ ] 6.1 Create js/modules/claims/ directory structure
  ...
  - [ ] 6.8 Update main.js to use claims-core module
...
- [ ] 7. Checkpoint - Verify chat and claims refactoring complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Refactor main.js initialization logic
  - [ ] 8.1 Create js/modules/init/ directory structure
  ...
  - [ ] 8.2 Create init-async-batch.js module
    - Extract initAsyncBatch function from main.js
    - Export initialization function
    - _Requirements: 4.4, 4.5_
  
  - [ ] 8.3 Create init-large-batch.js module
    - Extract initLargeBatch function from main.js
    - Export initialization function
    - _Requirements: 4.4, 4.5_
  
  - [ ] 8.4 Create init-local-patent-lib.js module
    - Extract initLocalPatentLib function from main.js
    - Export initialization function
    - _Requirements: 4.4, 4.5_
  
  - [ ] 8.5 Create init-claims-comparison.js module
    - Extract initClaimsComparison function from main.js
    - Export initialization function
    - _Requirements: 4.4, 4.5_
  
  - [ ] 8.6 Create init-patent-batch.js module
    - Extract initPatentBatch function from main.js
    - Export initialization function
    - _Requirements: 4.4, 4.5_
  
  - [ ] 8.7 Refactor main.js to orchestrate initialization
